...
import WonderIcon from "@/assets/MateManos.png";
...
export default function WonderSection() {
  ...
  return (
    ...
    <div className="w-full relative flex items-start gap-10 p-10 xl:p-20 pr-0 xl:pr-0">
      ...
      <div className="flex-1 flex flex-col gap-32">
        ...
        {/* Cabecera / Hero de Wonder */}
        <section className="w-full flex flex-col gap-10">
          <h1 className="text-white font-bold text-6xl">Wonder</h1>
          <div className="w-full flex flex-row gap-5">
            <div className="w-[50%] p-10">
              <LaptopMockup screenImage={[WonderIcon]} />
            </div>
            <div className="w-[50%]">
              <PhoneMockup3D images={[WonderIcon]} />
            </div>
          </div>
        </section>
